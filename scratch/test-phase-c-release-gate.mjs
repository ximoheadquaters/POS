...
async function runReleaseGate() {
  ...
  try {
    ...
    // A. Create Bulk Sugar
    const bulkSugarRes = await client.query(
    ...
    const sackVariantRes = await client.query(
    ...
    const pouchRes = await client.query(
      `insert into products (organization_id, name, sku, unit, inventory_role, preparation_behavior, track_inventory, cost, selling_price, status)
    ...
    const sugar500Res = await client.query(
      `insert into products (organization_id, name, sku, unit, inventory_role, preparation_behavior, track_inventory, cost, selling_price, status)
    ...
    const multiProductRes = await client.query(
      `insert into products (organization_id, name, sku, unit, inventory_role, preparation_behavior, track_inventory, cost, selling_price, status)
    ...
    const boxVariantRes = await client.query(
